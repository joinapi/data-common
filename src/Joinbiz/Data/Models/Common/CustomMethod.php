...
class CustomMethod extends Model
{
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\PartyAcctgPreference', 'invoice_seq_cust_meth_id', 'custom_method_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\PartyAcctgPreference', 'order_seq_cust_meth_id', 'custom_method_id');
    }
    ...
    {
        return $this->hasMany('Joinbiz\Data\Models\Accounting\PartyAcctgPreference', 'quote_seq_cust_meth_id', 'custom_method_id');
    }
